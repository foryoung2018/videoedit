...
public interface ApiService {
     ...
     */
    @GET
    Observable<Response<BaseResponse>> sendVideoDownLoad(@Url String url,
                                                         @Query("url") String url1,
                                                         @Query("opus_id") String opus_id,
                                                         @Query("file_len") String viewLength,
                                                         @Query("download_len") String shareCount,
                                                         @Query("download_duration") String downLoadCount,
                                                         @Query("download_speed") String speed,
                                                         @Query("buffer_duration") String buffer_duration,
                                                         @Query("buffer_count") String buffer_count,
    ...
    @GET
    Observable<Response<CreativeTemplateBean>> getTemplateSocal(@Url String url, @Query("template_name") String template_name, @Query("bg_name") String bg_name);
