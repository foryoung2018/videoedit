...
public class GlobalParams {
    ...
    public interface EventType {
        ...
        int TYPE_LOCAL_UPLOAD_MV = 600011;//MV 本地上传，返回视频，
    ...
    public interface MWConfig {
        ...
        String LINK_KEY_CREATIVE  = "creative";
        String LINK_KEY_MULTIGRID  = "multigrid";
        String LINK_KEY_JOINTEAMWORK  = "multigrid";
    }
