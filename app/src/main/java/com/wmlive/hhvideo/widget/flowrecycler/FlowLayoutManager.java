...
/**
 * Created by lsq on 1/8/2018.5:32 PM
 *
 * @author lsq
 * @describe 添加描述
 */
...
public class FlowLayoutManager extends RecyclerView.LayoutManager {
    ...
    public FlowLayoutManager(boolean isFlat, boolean isGreyItem,
    ...
    private void layoutItems(RecyclerView.Recycler recycler,
        ...
        for (int i = 0; i < getItemCount(); i++) {
            b = mAllItemFrames.get(i);
            if (b != null && Rect.intersects(displayFrame, b) && !mHasAttachedItems.get(i)) { //重新加载可见范围内的Item
...
//            cm.setSaturation(0.9f);
    ...
    /**
     * 获取中间位置
     * <p>Note:该方法主要用于{@link FlowRecyclerView#getChildDrawingOrder(int, int)}判断中间位置
    ...
    public static class Builder {
        ...
        public FlowLayoutManager build() {
            return new FlowLayoutManager(isFlat, isGreyItem,
