 ...
 * </p>
 */
public class SwipeRefreshRelativeLayout extends RelativeLayout implements NestedScrollingParent,
    ...
    private static final String LOG_TAG = SwipeRefreshRelativeLayout.class.getSimpleName();
     ...
     * @param context
     */
    public SwipeRefreshRelativeLayout(@NonNull Context context) {
        this(context, null);
    }
     ...
     * @param attrs
     */
    public SwipeRefreshRelativeLayout(@NonNull Context context, @Nullable AttributeSet attrs) {
        super(context, attrs);
    ...
    /**
     * Set a callback to override {@link SwipeRefreshRelativeLayout#canChildScrollUp()} method. Non-null
...
//    }
    ...
    /**
     * Classes that wish to override {@link SwipeRefreshRelativeLayout#canChildScrollUp()} method
     * behavior should implement this interface.
     */
    public interface OnChildScrollUpCallback {
        /**
         * Callback that will be called when {@link SwipeRefreshRelativeLayout#canChildScrollUp()} method
         ...
         */
        boolean canChildScrollUp(@NonNull SwipeRefreshRelativeLayout parent, @Nullable View child);
    }
}
