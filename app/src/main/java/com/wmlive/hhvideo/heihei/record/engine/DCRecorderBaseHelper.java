...
//                打开相机失败处理
    ...
    public void previewCamera(RelativeLayout relativeLayout) {
        ...
        //设置滤镜
        getDcRecorderCore().switchFilter(selectFilter % FILTER_LIST.size());
        KLog.i("filter---select->"+(selectFilter % FILTER_LIST.size()));
    }

    public void setPara(){
        getDcRecorderCore().setPara();
    }
