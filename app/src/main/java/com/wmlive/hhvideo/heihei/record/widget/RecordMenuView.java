...
public class RecordMenuView extends BaseCustomView {
    ...
    public void setFlashEnable(boolean enable, boolean isFront) {
        ...
        ivFlash.setImageResource(enable ? (isFront ? R.drawable.icon_video_topbar_flash_on : R.drawable.icon_video_topbar_flash_off) : R.drawable.icon_video_topbar_flash_off_dis);
    }
