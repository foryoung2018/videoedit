...
//    RecordOptionView viewSpeed;
    ...
    private final int[] iconCountIds = new int[]{
            R.drawable.icon_video_bottombar_count_nor,
            R.drawable.icon_video_bottombar_count_3_nor,
            R.drawable.icon_video_bottombar_count_10_nor};
...
//        viewSpeed.setOnClickListener(this);
    ...
    public void setCountDown(int status){
        this.status = status;
        viewCountDown.ivIcon.setImageResource( iconCountIds[this.status]);
    }
    ...
    public void setCountdownEnable(boolean enable) {
        ...
        viewCountDown.ivIcon.setImageResource(enable ? iconCountIds[this.status] : R.drawable.icon_video_bottombar_count_dis);
    }
