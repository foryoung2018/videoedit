...
//        }
    ...
    public void showPublishError(int type, String message) {
    ...
    public void publish(boolean ifsave, List<MediaObject> assets) {
        publishPresenter = new PublishMvPresenter(publishView);
        publishPresenter.preparePublish(RecordManager.get().getProductEntity(), ifsave, assets);
    }
}
