...
public class RecordOptionPanelMV extends BaseCustomView {
    ...
    public void setCountDown(int status){
        switch (status){
            case 0:
                viewCountDown.ivIcon.setImageResource( iconCountIds[0]);
                break;
            case 1:
                viewCountDown.ivIcon.setImageResource( iconCountIds[1]);
                break;
            case 2:
                viewCountDown.ivIcon.setImageResource( iconCountIds[2]);
                break;
            default:
                break;
        }
