...
public class SearchVideoActivity extends DcBaseActivity implements TabLayout.OnTabSelectedListener {
    ...
    public static final int TYPE_FROM_RECORDMV = 40;//速拍跳转
    ...
    public static void startSearchVideoActivity(final BaseCompatActivity context, final int index, final int startType, long recordDuration) {
                    ...
                    public void accept(Permission permission) throws Exception {
                        ...
                        if (count.type == 3) {
                            ...
                            if (result == 0) {
                                ...
                                bundle.putLong(SHORT_VIDEO_DURATION, recordDuration);
                                intent.putExtras(bundle);
                                context.startActivityForResult(intent,startType);
                            } else if (result == -1) {
    ...
    protected void initData() {
        ...
        if (null != intent) {
            ...
            minDuration = intent.getLongExtra(SHORT_VIDEO_DURATION,0);
    ...
    protected void initView() {
        ...
        allLocalViedoFragment = AllLocalViedoFragment.newInstance(startType, shortVideoIndex,minDuration);
        localAlbumsFragment = LocalAlbumsFragment.newInstance(startType, shortVideoIndex,minDuration);
...
//                                    LocalVideoTrimActivity.startLocalVideoTrimActivity(SearchVideoActivity.this, RecordManager.get().getProductEntity().combineVideoAudio);
    ...
    protected void onActivityResult(int requestCode, int resultCode, Intent data) {
        if (resultCode == Activity.RESULT_OK) {//是否选择，没选择就不会继续
            ...
            String path;
            if (startType == TYPE_FROM_RECORDMV) {
                //TODO 编辑完的视频
                ...
                intent.putExtra(SearchVideoActivity.SHORT_VIDEO_PATH, videoPath);
                intent.putExtra(SearchVideoActivity.SHORT_AUDIO_PATH, audioPath);
