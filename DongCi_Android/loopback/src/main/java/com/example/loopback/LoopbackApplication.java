...
public class LoopbackApplication {
    ...
    String getMicSourceString(int source) {
        String name = null;
        String[] myArray = context.getResources().getStringArray(R.array.mic_source_array);
    ...
    String getPerformanceModeString(int performanceMode) {
        String name = null;
        String[] myArray = context.getResources().getStringArray(R.array.performance_mode_array);
    ...
    public void computeDefaults() {
        if (mAudioThreadType == Constant.AUDIO_THREAD_TYPE_NATIVE_SLES ||
            ...
            mSettings = NativeAudioThread.computeDefaultSettings(
                    this.context, mAudioThreadType, mPerformanceMode);
        } else {
