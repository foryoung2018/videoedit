...
public class DCRenderObject {
    ...
    public void draw(DCMatrixStack matrixStack, long presentationTime, DCActor actor, DCTimeEvent timeEvent, GPUImageFilterGroup filter, int viewportWidth, int viewportHeight) {
        ...
        matrixStack.gl_pushMatrix();
        {
            ...
            matrixStack.gl_rotate(actor.rotation);
