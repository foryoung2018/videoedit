...
import com.dongci.sun.gpuimglibrary.common.MyApplication;
...
public class TextureRender {
    ...
    public TextureRender(VideoInfo info) {
        ...
        mShow = new NoFilter(MyApplication.context.getResources());
        mShow.setMatrix(MatrixUtils.flip(MatrixUtils.getOriginalMatrix(), false, true));
        rotationFilter = new RotationOESFilter(MyApplication.context.getResources());
    }
