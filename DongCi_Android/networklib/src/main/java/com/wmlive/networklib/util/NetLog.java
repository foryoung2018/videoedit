...
/**
 * 使用时请在Application类中调用 {@link #init(boolean, String)}方法
 */
public class NetLog {
    ...
    private static String[] wrapperContent(String tagStr, Object... objects) {
        ...
        return new String[]{TextUtils.isEmpty(tag) ? TAG_DEFAULT : tag, msg, headString};
    }
    ...
    public static void printJson(String tag, String msg, String headString) {
        ...
        try {
            if (msg.startsWith("{")) {
                ...
                message = jsonObject.toString(NetLog.JSON_INDENT);
            } else if (msg.startsWith("[")) {
                JSONArray jsonArray = new JSONArray(msg);
                message = jsonArray.toString(NetLog.JSON_INDENT);
            } else {
                message = msg;
            }
        ...
        printLine(tag, true);
        message = headString + NetLog.LINE_SEPARATOR + message;
        String[] lines = message.split(NetLog.LINE_SEPARATOR);
    ...
    public static void printXml(String tag, String xml, String headString) {
        if (xml != null) {
            ...
            xml = headString + NetLog.NULL_TIPS;
        }

        printLine(tag, true);
        String[] lines = xml.split(NetLog.LINE_SEPARATOR);
        for (String line : lines) {
            if (!isEmpty(line)) {
                Log.d(tag, "║ " + line);
            }
