...
import com.wmlive.hhvideo.heihei.record.uird.ICameraZoomHandler;

import static com.wmlive.hhvideo.heihei.record.uird.ICameraZoomHandler.ZOOM_STOPPED;
...
public class LiveCameraZoomHandler implements ICameraZoomHandler {
    ...
    @Override
    public void setMainCamera(Camera var1) {
        this.m_mainCamera = var1;
    }
    ...
    private class ZoomChangeListener implements
        ...
        public void onZoomStateChanged(int state) {
            if (m_bPausing)
                return;
//            Log.d(TAG, "zoom picker state=" + state);
