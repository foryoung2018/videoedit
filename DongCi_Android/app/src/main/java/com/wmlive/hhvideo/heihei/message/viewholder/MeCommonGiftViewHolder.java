...
public class MeCommonGiftViewHolder extends BaseRecyclerViewHolder {

    @BindView(R.id.tv_im_detail_me_content_gift)
    public TextView mTvContent;

    private MessageDetail mData;
    private Context mContext;

    public MeCommonGiftViewHolder(View itemView, Context context) {
        super(itemView);
        mContext = context;
    }
