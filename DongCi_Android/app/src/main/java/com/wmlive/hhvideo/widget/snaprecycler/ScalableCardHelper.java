package com.wmlive.hhvideo.widget.snaprecycler;
...
/**
 * Created by lsq on 6/1/2018 - 10:41 AM
 * 类描述：
 */
...
public class ScalableCardHelper {
    ...
    private void pageScrolled() {
        ...
        KLog.d(TAG, String.format("left: %f, right: %f, current: %f", leftSnapingOffset, rightSnapingOffset, currentSnapingOffset));
    }
