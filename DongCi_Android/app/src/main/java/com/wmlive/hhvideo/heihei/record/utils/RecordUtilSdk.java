...
//    }
     ...
     * @param exportListener
     */
    public static void exportMvVideo(List<Scene> list, MVideoConfig videoConfig, ExportListener exportListener) {
        VideoEngine videoEngine = new VideoEngine();
    ...
    public static List<Scene> addWaterExport(List<Scene> scenes, String imgPath,int videoWidth,int videoHeight) {
        ...
        float h = 2f*(0.16415f-videoHeight*1.0f/8480f);
        float w = 2f*(0.16415f-videoWidth*1.0f/8480f);
        KLog.i("water-export--222>" + w+"VideoHeight:>"+h);
        //前五秒，左上角
        ...
        mediaObject.setRectInVideo(new RectF(0, 0, w, h));
        mediaObject.setShowRectF(new RectF(0, 0, (int) (WATERMARK_HEIGHT ), WATERMARK_HEIGHT));
        mediaObject.setVolume(1.0f);
        mediaObject.assetId = 10;
        //之后所有时间

        //右下角
        MediaObject mediaObjectEnd = new MAsset(imgPath, DCAsset.DCAssetTypeImage);
        mediaObjectEnd.setSourceType(DCAsset.DCAssetTypeImage);
        mediaObjectEnd.setTimeRange(5 * 1000 * 1000, scene.getDuration() < 5000000 ? 60000000 : scene.getDuration());
        KLog.e("water-export--Time>" + scene.getDuration());
        mediaObjectEnd.setStartTimeInScene(5 * 1000 * 1000);
        mediaObjectEnd.setRectInVideo(new RectF(1.0f-w, 1-h, 1, 1));
        mediaObjectEnd.setShowRectF(new RectF(0, 0, (int) (WATERMARK_HEIGHT ), WATERMARK_HEIGHT));
        mediaObjectEnd.setVolume(1.0f);
        mediaObjectEnd.assetId = 11;
        scene.assets.add(mediaObject);
        scene.assets.add(mediaObjectEnd);
        scenes.set(0, scene);
        return scenes;
    }
    ...
    public static List<Scene> addWaterExportMv(List<Scene> scenes, String imgPath,int videoWidth,int videoHeight) {
        ...
        mediaObject.setTimeRange(0, 5 * 1000 * 1000);
        mediaObject.setStartTimeInScene(0);
        mediaObject.setRectInVideo(new RectF(0, 0, 0.15f,0.1f));
        mediaObject.setShowRectF(new RectF(0, 0, (int) (WATERMARK_HEIGHT ), WATERMARK_HEIGHT));
        mediaObject.setVolume(1.0f);
        mediaObject.assetId = 7;
        //之后所有时间
        ...
        KLog.e("water-export--Time>" + scene.getDuration());
        mediaObjectEnd.setStartTimeInScene(5 * 1000 * 1000);
        mediaObjectEnd.setRectInVideo(new RectF(0.85f, 0.9f, 1, 1));
        mediaObjectEnd.setShowRectF(new RectF(0, 0, (int) (WATERMARK_HEIGHT ), WATERMARK_HEIGHT));
        mediaObjectEnd.setVolume(1.0f);
        mediaObjectEnd.assetId = 8;
        scene.assets.add(mediaObject);
        scene.assets.add(mediaObjectEnd);
        scenes.set(0, scene);
        return scenes;
...
//    }
    ...
    public static void exportWaterMarkVideo(List<Scene> list, MVideoConfig videoConfig, ExportListener exportListener) {
        String watermark = GraphicsHelper.createWatermark(AccountUtil.getDcNum());
        KLog.e("water-export--imgPath-->>" + watermark);
