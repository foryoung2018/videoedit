 ...
 * 百度升级
 */
public class BaiduUpdateDialog extends Dialog implements OnClickListener {
    ...
    public BaiduUpdateDialog(Context context) {
        ...
        setContentView(R.layout.dialog_baidu_update);
     ...
     * 是否强制升级
     *
     * @param isForeceUpdata
     */
    public void setForceUpdate(boolean isForeceUpdata) {
        if (isForeceUpdata) {
            if (cancel != null) {
