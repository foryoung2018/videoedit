...
public class SelectStepPanel extends BaseCustomView {
    ...
    public void dismiss() {
        llQuickShoot.startAnimation(AnimationUtils.loadAnimation(getContext(), R.anim.anim_damp_out));
        ivClose.startAnimation(AnimationUtils.loadAnimation(getContext(), R.anim.anim_rotate_left));
        postDelayed(new Runnable() {
            @Override
            public void run() {
                llUpload.startAnimation(AnimationUtils.loadAnimation(getContext(), R.anim.anim_damp_out));
            }
        }, 100);
        postDelayed(new Runnable() {
            @Override
            public void run() {
                llRecord.startAnimation(AnimationUtils.loadAnimation(getContext(), R.anim.anim_damp_out));
            }
        }, 200);
