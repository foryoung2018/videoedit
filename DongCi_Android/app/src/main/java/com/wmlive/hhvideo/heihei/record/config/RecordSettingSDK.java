...
public class RecordSettingSDK {
    ...
    public static final int VIDEO_PUBLISH_BITRATE_HEIGHT = 1500*1000;//5000000;//发布时的比特率(720 * 960)
    public static final int VIDEO_PUBLISH_BITRATE_HEIGHT_MV = 3500*1000;//5000000;//发布时的比特率(720 * 960)
