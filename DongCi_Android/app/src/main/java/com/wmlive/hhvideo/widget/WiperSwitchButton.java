...
import com.wmlive.hhvideo.utils.ColorUtils;

import cn.wmlive.hhvideo.R;


/**
 * Created by jianfei.geng on 2016-12-15.
 */

public class WiperSwitchButton extends CompoundButton {
    public static final float DEFAULT_BACK_MEASURE_RATIO = 1.8f;
    public static final int DEFAULT_THUMB_SIZE_DP = 20;
    public static final int DEFAULT_THUMB_SIZE_DP_1 = 18;
    ...
    private void init(AttributeSet attrs) {
        ...
        float thumbHeight = density * DEFAULT_THUMB_SIZE_DP_1;
        ...
        TypedArray ta = attrs == null ? null : getContext().obtainStyledAttributes(attrs, R.styleable.WiperSwitchButton);
        if (ta != null) {
            thumbDrawable = ta.getDrawable(R.styleable.WiperSwitchButton_kswThumbDrawable);
            thumbColor = ta.getColorStateList(R.styleable.WiperSwitchButton_kswThumbColor);
            margin = ta.getDimension(R.styleable.WiperSwitchButton_kswThumbMargin, margin);
            marginLeft = ta.getDimension(R.styleable.WiperSwitchButton_kswThumbMarginLeft, margin);
            marginRight = ta.getDimension(R.styleable.WiperSwitchButton_kswThumbMarginRight, margin);
            marginTop = ta.getDimension(R.styleable.WiperSwitchButton_kswThumbMarginTop, margin);
            marginBottom = ta.getDimension(R.styleable.WiperSwitchButton_kswThumbMarginBottom, margin);
            thumbWidth = ta.getDimension(R.styleable.WiperSwitchButton_kswThumbWidth, thumbWidth);
            thumbHeight = ta.getDimension(R.styleable.WiperSwitchButton_kswThumbHeight, thumbHeight);
            thumbRadius = ta.getDimension(R.styleable.WiperSwitchButton_kswThumbRadius, Math.min(thumbWidth, thumbHeight) / 2.f);
            backRadius = ta.getDimension(R.styleable.WiperSwitchButton_kswBackRadius, thumbRadius + density * 2f);
            backDrawable = ContextCompat.getDrawable(getContext(), R.drawable.icon_tipbutton_bg_on);
            backColor = ta.getColorStateList(R.styleable.WiperSwitchButton_kswBackColor);
            backMeasureRatio = ta.getFloat(R.styleable.WiperSwitchButton_kswBackMeasureRatio, backMeasureRatio);
            animationDuration = ta.getInteger(R.styleable.WiperSwitchButton_kswAnimationDuration, animationDuration);
            fadeBack = ta.getBoolean(R.styleable.WiperSwitchButton_kswFadeBack, true);
            tintColor = ta.getColor(R.styleable.WiperSwitchButton_kswTintColor, tintColor);
            textOn = ta.getString(R.styleable.WiperSwitchButton_kswTextOn);
            textOff = ta.getString(R.styleable.WiperSwitchButton_kswTextOff);
            textMarginH = Math.max(textMarginH, backRadius / 2);
            textMarginH = ta.getDimension(R.styleable.WiperSwitchButton_kswTextMarginH, textMarginH);
            autoAdjustTextPosition = ta.getBoolean(R.styleable.WiperSwitchButton_kswAutoAdjustTextPosition, autoAdjustTextPosition);
            ta.recycle();
        }
