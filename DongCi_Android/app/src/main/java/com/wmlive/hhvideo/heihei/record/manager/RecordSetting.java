...
public class RecordSetting {
    ...
    public static final int VIDEO_EXPORT_WIDTH = 720;//视频的宽度
    public static final int VIDEO_EXPORT_HEIGHT = 1280;//视频的高度

    public static final int LOCAL_UPLOAD_VIDEO_MAX = 960;//本地单个上传发布的作品宽高最大值

    public static final int VIDEO_FRAME_RATE = 24;//视频的帧率
    public static final int VIDEO_RECORD_BITRATE = 10000000;//8000000;//录制时的比特率
    public static final int VIDEO_PUBLISH_BITRATE = 5000000;//5000000;//发布时的比特率(720 * 960)
    public static final int VIDEO_PUBLISH_BITRATE_SMALL = 3000000;//3000000;//发布时的比特率(480 * 640)
    ...
    public static final int WATERMARK_HEIGHT = 148; // 水印高度
    public static final int WATERMARK_WIDTH = 132; // 水印高度
...
//        FILTER_LIST.add(new FilterInfoEntity(index++, R.drawable.recorder_filter_27, R.string.filter_28));
    ...
    public RecordSetting(int videoWidth, int videoHeight,
    ...
    public static RecordSetting initSetting() {
        ...
        return RecordSetting.defaultSetting();
    }
