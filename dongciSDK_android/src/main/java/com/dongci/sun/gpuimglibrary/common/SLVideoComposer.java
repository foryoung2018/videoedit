...
/**
 * Created by yangjiangang on 2018/5/31.
 */

@TargetApi(18)
public class SLVideoComposer {
    private final String TAG = "SLVideoComposer";
    ...
    public SLVideoComposer(ArrayList<String> videoList, String outFilename) {
