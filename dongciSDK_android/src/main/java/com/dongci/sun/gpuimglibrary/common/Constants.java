...
public class Constants {
     ...
     * 三种画幅的具体编码尺寸(参考VUE)
     */
    public static final int mode_por_encode_width_9_16 = 544;
    public static final int mode_por_encode_height_9_16 = 960;
    public static final int mode_por_encode_width_1_1 = 720;
    public static final int mode_por_encode_height_1_1 = 720;
    public static final int mode_por_encode_width_16_9 = 960;
    public static final int mode_por_encode_height_16_9 = 544;
    ...
    public static String getBaseFolder() {
        ...
        if (!f.exists()) {
            boolean b = f.mkdirs();
            if (!b) {
                baseFolder = MyApplication.context.getExternalFilesDir(null).getAbsolutePath() + "/";
            }
        }
        return baseFolder;
    }
