...
import com.dongci.sun.gpuimglibrary.common.SLSample;
...
public class SLTrack {
    ...
    private ArrayList<SLSample> samples = new ArrayList<SLSample>();
    ...
    public SLTrack(int id, MediaFormat format, boolean isAudio) throws Exception {
        trackId = id;
        if (!isAudio) {
    ...
    public void addSample(long offset, MediaCodec.BufferInfo bufferInfo) {
        ...
        samples.add(new SLSample(offset, bufferInfo.size));
    ...
    public ArrayList<SLSample> getSamples() {
        return samples;
    }
