...
public class GPUImageBilateralFilter extends GPUImageTwoPassTextureSamplingFilter {
	...
	private int mSecondDisFactorLocation;
	...
	public void onInit() {
		super.onInit();
		mDisFactorLocation = GLES20.glGetUniformLocation(getFilters().get(0).getProgram(), "distanceNormalizationFactor");
		mSecondDisFactorLocation = GLES20.glGetUniformLocation(getFilters().get(1).getProgram(), "distanceNormalizationFactor");
	}
	...
	public void setDistanceNormalizationFactor(final float newValue) {
		...
		setFloat(mSecondDisFactorLocation, newValue);
	}
